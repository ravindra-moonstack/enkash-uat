  ...
  return (
    <div className={`bg-indi-volt color-white ${styles.home_container}`}>
      ...
      >
        ...
        <div className="mb-5">
          <Heading
            title="Don't worry! Our FAQs section will help you learn about CFO suite in detail"
            color="black"
            size="h4"
          />
        </div>
      ...
      <div className={`${styles.sixth_row} row`}>
        <ContactUsCard
          title="Seeking further understanding of CFO suite?"
          description='The "CFO Suite"  is designed specifically for Chief Financial Officers (CFOs). It aims to automate tasks, facilitate data-backed decision-making, and streamline financial processes within organizations. '
          source=""
        />
      </div>
