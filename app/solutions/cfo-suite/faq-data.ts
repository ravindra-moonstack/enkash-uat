const faqData = [
    ...
    answer: [
      {
        ...
        bullets: [
          "Automate tasks, streamline workflows, and reduce administrative burdens",
          "Enforce spending policies, track expenses in real-time, and mitigate fraud risks",
          "Gain access to real-time data and insights for informed financial decisions",
          "Control spending, eliminate unnecessary costs, and align budgets with financial goals",
        ],
      },
    ],
  },
  {
    ...
    answer: [
      {
        heading:
          "Getting started is easy! Simply sign up for a free account and complete the KYC process. You can also book a demo to learn more about the platform and its features.",
      },
    ],
  },
  {
