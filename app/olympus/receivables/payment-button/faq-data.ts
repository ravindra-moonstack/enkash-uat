    ...
    answer: [
      {
        bullets: [
          ...
          "LAdd button details like title and button type",
          "LGenerate the button and copy the code ",
          "LEmbed the payment button code on your business website ",
          "LCustomers will be redirected to the EnKash payment gateway by clicking on the payment button ",
        ],
      },
    ],
  },
