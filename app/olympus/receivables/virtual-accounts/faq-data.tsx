...
const faqData: FAQProps[] = [
  ...
  {
    question: "Who is eligible to open a virtual bank account in India?",
    answer: [
      {
        heading:
  ...
  {
    question: "What are the benefits of a virtual account?",
    answer: [
      {
        heading:
  ...
  {
    question: "How virtual account will benefit my business?",
    answer: [
      {
        heading:
  ...
  {
    question: "What is the need for a virtual account?",
    answer: [
      {
        heading: "Businesses need virtual accounts to:",
      },
      {
        bullets: [
  ...
  {
    question: "How to create a virtual bank account?",
    answer: [
      {
        heading:
...
const secondFaqData: FAQProps[] = [
  ...
  {
    question: "Why should a business consider virtual accounts?",
    answer: [
      {
        heading:
  ...
  {
    question: "How does the virtual accounts module curb misuse?",
    answer: [
      {
        heading:
