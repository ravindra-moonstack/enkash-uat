const faqData = [
  ...
  },
  {
    ...
    answer: [
      {
        heading: "You can view all the settlements for payments that are collected via the auto-collect solution through EnKash’s reporting dashboard. This centralized dashboard offers comprehensive insights into your payment settlements, enabling efficient monitoring and management of your financial transactions.",
      },
    ],
  },
  {
    ...
    answer: [
      {
        heading: "Auto collect enhances efficiency and accuracy by automating the reconciliation process and providing real-time reconciliation capabilities. This minimizes errors, improves accuracy, and eliminates the need for manual intervention, thereby saving time and streamlining financial operations.",
      },
    ],
  },
  {
    question: "In what ways does auto collect contribute to an improved customer experience?",
    answer: [
      {
        heading: "Auto collect contributes to an improved customer experience by offering flexible payment settlements and real-time alerts. It ensures timely access to funds, even on bank holidays, and provides immediate notifications of successful payments, enhancing transparency and reliability for both businesses and customers.",
      },
    ],
  },
];
