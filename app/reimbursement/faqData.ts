const faqData = [
  {
    question: "How can I apply for a meal card?",
    answer: {
      heading:
  ...
  {
    question: "Is there a limit to how much I can load on my meal card?",
    answer: {
      heading:
  ...
  {
    question: "Are there any fees associated with the meal card?",
    answer: {
      heading:
  ...
  {
    question: "How do I check my meal card balance?",
    answer: {
      heading:
  ...
  {
    question: "Can I track meal card expenses?",
    answer: {
      heading:
