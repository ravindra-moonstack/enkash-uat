const faqData = [
  {
    question: "What is Quick Collect?",
    answer: {
      heading:
  ...
  {
    question: "What kind of payment options can be enabled with payment links?",
    answer: {
      heading:
  ...
  {
    question: "How does quick collect help with quicker collections?",
    answer: {
      heading:
  ...
  {
    question: "How does quick collect help optimize my collection strategy?",
    answer: {
      heading:
  ...
  {
    question: "What kind of data and insights does quick collect provide?",
    answer: {
      heading:
