const faqData = [
  ...
  {
    question: "How can optimizing invoicing processes improve collections?",
    answer: [
      {
        heading:
  ...
  {
    question:
      "Why is offering multiple payment options important in invoicing?",
    answer: [
      {
        heading:
