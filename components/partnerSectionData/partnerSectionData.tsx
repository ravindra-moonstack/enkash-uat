          ...
          <div key={idx} className={`${Styles.partnerList}`}>
            ...
            <div className={`${Styles.content}`}>
              {partner.title && (
                <DynamicHeading
                  content={[
                    { title: partner.title, color: "color-black  " },
                  ]}
                  headingTag="h6"
                  className="f-4"
                />
              ...
              {partner.buttonLinks && partner.buttonText && (<div className={`${Styles.buttonsSection}`}>
                <Link href={partner.buttonLinks} className={`${Styles.buttons}`}>
                  {partner.buttonText}
                  <svg
                    width="12"
                    height="11"
