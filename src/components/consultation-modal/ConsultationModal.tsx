  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        ...
        .test(
          "is-business-email",
          "Personal domains are not allowed. Please enter your business email.",
          (value) => {
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const sanitizedPhone =
          cleanedPhone.length > 10 ? cleanedPhone.slice(-10) : cleanedPhone
        ...
        if (rawHtml && rawHtml.includes("Error Occurred!")) {
          ...
          if (Object.keys(fieldErrors).length > 0) {
            ...
            const touchedState = Object.keys(fieldErrors).reduce(
              (acc, key) => {
                acc[key] = true
                return acc
              },
      ...
      <div className={styles.modal_body}>
        ...
        <div className={styles.content_wrapper}>
          <h2 className={styles.title}>
            Reading About Problems Won’t Fix Them.
          </h2>
          <p className={styles.subtitle}>
            Get practical answers for your business from people who’ve built the
            solutions.
          </p>
          ...
          {submitError && (
            <div className={styles.form_error_message}>{submitError}</div>
          )}

          <div className={styles.submit_btn_wrapper}>
            <CommonButton
              title={loading ? "Submitting..." : "Let's Do This"}
              theme="blue"
              url={formik.handleSubmit}
              isDisabled={loading}
