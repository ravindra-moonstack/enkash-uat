...
// ---------------------------------------------------------------------------
function createImageResizer(quill: any, onContentChange: (html: string) => void) {
    ...
    const HANDLES: Array<{
        ...
        ax: boolean; ay: boolean; dx: number; dy: number;
        // position on the overlay (top/bottom/left/right as % or keyword)
        top: string; left: string; transform: string;
    }> = [
        { name: 'nw', cursor: 'nw-resize', ax: true,  ay: true,  dx: -1, dy: -1, top: '0%',   left: '0%',   transform: 'translate(-50%,-50%)' },
        { name: 'n',  cursor: 'n-resize',  ax: false, ay: true,  dx:  0, dy: -1, top: '0%',   left: '50%',  transform: 'translate(-50%,-50%)' },
        { name: 'ne', cursor: 'ne-resize', ax: true,  ay: true,  dx:  1, dy: -1, top: '0%',   left: '100%', transform: 'translate(-50%,-50%)' },
        { name: 'e',  cursor: 'e-resize',  ax: true,  ay: false, dx:  1, dy:  0, top: '50%',  left: '100%', transform: 'translate(-50%,-50%)' },
        { name: 'se', cursor: 'se-resize', ax: true,  ay: true,  dx:  1, dy:  1, top: '100%', left: '100%', transform: 'translate(-50%,-50%)' },
        { name: 's',  cursor: 's-resize',  ax: false, ay: true,  dx:  0, dy:  1, top: '100%', left: '50%',  transform: 'translate(-50%,-50%)' },
        { name: 'sw', cursor: 'sw-resize', ax: true,  ay: true,  dx: -1, dy:  1, top: '100%', left: '0%',   transform: 'translate(-50%,-50%)' },
        { name: 'w',  cursor: 'w-resize',  ax: true,  ay: false, dx: -1, dy:  0, top: '50%',  left: '0%',   transform: 'translate(-50%,-50%)' },
    ];
    ...
    function updateLabel(w: number, h: number) {
        if (!overlay) return;
        const label = overlay.querySelector('#__img_resize_label') as HTMLElement | null;
