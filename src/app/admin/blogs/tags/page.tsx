...
export default function TagsPage() {
    ...
    const fetchTerms = async () => {
        setLoading(true)
        try {
            const res = await fetch(`/api/admin/terms?taxonomy=post_tag&page=${page}&limit=${itemsPerPage}&search=${search}&sortBy=${sortBy}&sortOrder=${sortOrder}`)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault()
        const payload = { name, slug, description, taxonomy: "post_tag" }
        ...
        <div className={styles.container}>
            ...
            <div className={styles.layout}>
                <div className={styles.leftColumn}>
                    <h2>{editId ? "Edit Tag" : "Add New Tag"}</h2>
                    ...
                    <table className={styles.table}>
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={4} style={{ textAlign: 'center', padding: '20px' }}>No tags found.</td>
                                </tr>
                            ) : (
                                terms.map(term => (
                                    <tr key={term.term_id}>
