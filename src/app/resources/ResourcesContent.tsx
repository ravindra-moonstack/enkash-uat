                        ...
                        {currentRes.pagination.totalPages > 1 && (
                            <>
                                <div
                                    ...
                                    onClick={() => handlePageChange(currentRes.pagination.page - 1)}
                                    style={{ pointerEvents: currentRes.pagination.page === 1 ? 'none' : 'auto', opacity: currentRes.pagination.page === 1 ? 0.5 : 1 }}
                                >
                                    &lt;
                                </div>
                                ...
                                {[...Array(currentRes.pagination.totalPages)].map((_, i) => {
                                    const p = i + 1
                                    if (p === 1 || p === currentRes.pagination.totalPages || (p >= currentRes.pagination.page - 1 && p <= currentRes.pagination.page + 1)) {
                                        return (
                                            <div
                                                key={p}
                                    ...
                                    } else if (p === currentRes.pagination.page - 2 || p === currentRes.pagination.page + 2) {
                                ...
                                <div
                                    ...
                                    onClick={() => handlePageChange(currentRes.pagination.page + 1)}
                                    style={{ pointerEvents: currentRes.pagination.page === currentRes.pagination.totalPages ? 'none' : 'auto', opacity: currentRes.pagination.page === currentRes.pagination.totalPages ? 0.5 : 1 }}
                                >
                                    &gt;
                                </div>
                            </>
