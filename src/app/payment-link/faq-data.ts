const faqData = [
  ...
  },
  {
    ...
    answer: [
      {
        heading:
          "You can use an EnKash Payment Link in any way that works for you—just share it with your customers, and they can click to make the payment. Creating a Payment Link takes only two simple steps, and it can be automatically sent to your customer’s email and phone number. To share it on other platforms like WhatsApp, social media, or chatbots, simply copy the link from the dashboard and paste it where needed.",
      },
    ],
  },
  {
