            ...
            <div className="col-12 col-md-6 d-flex flex-column">
              ...
              >
                <div className="d-flex flex-column   pt-3 pt-md-0">
                  ...
                  <Heading
                    title="Business Collection with EnKash Bulk Collect"
                    color="black"
                    size="h2"
                    weight="7"
                  />
        ...
        <div className={`relative max-w-auto`}>
          <div className={`${styles.title} text-center pb-md-5 pb-3`}>
            ...
            <Heading
              ...
              weight="6"
            />
            <Heading title={`Works`} color="black" size="h1" weight="6" />
          </div>
          <div className="row">
        ...
        <div className="max-w-auto">
          <div className={`row  align-items-center ${styles.section}`}>
            <div className={`${styles.title} text-center `}>
              ...
              >
                <Heading
                  title={`Why EnKash for${space}`}
                  color="black"
                  size="h1"
                  weight="5"
                />
                <Heading
                  title={`Bulk Payment${space}`}
                  color="equity-blue"
                  size="h1"
                  weight="5"
                />
                <Heading
                  title={`Collection ${space}`}
                  color="black"
                  size="h1"
                  weight="5"
                />
