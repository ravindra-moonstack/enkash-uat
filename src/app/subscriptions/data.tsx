...
const cardsData = [
  ...
  {
    title: "Integrate",
    description: "Seamlessly integrate your business website with EnKash without any technical efforts.",
    icon: scrollIconTwo,
  },
  {
    title: "Collect",
    description: "Start receiving recurring payments from your customers as per their subscription plans.",
