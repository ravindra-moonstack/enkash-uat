    ...
    content: (
      <>
        <AllInOnePolicy
          ...
          description="Available in multiple denominations of up to Rs.10,000, ensuring the option to choose the card value as per your requirements"
