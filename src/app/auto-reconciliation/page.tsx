            ...
            <div className="col-12 col-md-6 d-flex flex-column">
              ...
              >
                <div className="d-flex flex-column   pt-3 pt-md-0">
                  <Heading
                    title={`Simplify Cash Flow with Automated Reconciliation${space}`}
                    color="black"
                    size="h2"
                    weight="7"
                  />
                ...
                <div className="d-flex mt-3 mb-3  text-center text-md-start ">
                  <Heading
                    title="Allow your finance team to focus on strategic tasks and automate the reconciliation process."
                    color="black"
                    size="h5"
                    weight="4"
                  />
        ...
        <div className="max-w-auto">
          <div className={`row  align-items-center ${styles.section}`}>
            <div className={`${styles.title} text-center `}>
              ...
              >
                <Heading
                  title={`Manage Finances Better With ${space}`}
                  color="black"
                  size="h1"
                  weight="5"
                />
