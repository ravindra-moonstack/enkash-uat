    ...
    return (
        <div className={`color-white  `}>
            ...
            <div className={`${styles.boxContainer}`}>
                <BankSolutions solutions={bankSolutions} heading={BankSolutionHeading} button={{
            ...
            <PartnershipSection
                ...
                buttons={[
                    { title: "Explore Bank Partnerships", theme: "blue", url: "#partnership-form" }
                ]}
                slideData={slideData}
            />
            ...
            <div className={`${styles.third_row}`}>
                <BottomCtaSection headingPart1="Unlock New Revenue Opportunities" headingPart2='by Partnering With EnKash' buttonHref='#partnership-form' />
            </div>
