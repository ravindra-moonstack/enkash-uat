...
const stepsData = [
  {
    ...
    description:
      "Mail us or fill the form below for our team to reach out to you.",
  },
  {
    stepNumber: "Step 2",
  ...
  },
  {
    ...
    description:
      "Go live with plug-and-play APIs, dedicated support, and GTM strategies to scale revenue and reach.",
  },
]
...
const BankSolutionHeading = {
  content: [
    {
      title: "Unified Solution for Banks Powered by ",
      color: "color-black f-2 d-md-block",
    },
