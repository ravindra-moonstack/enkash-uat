...
const LottieDynamicLoadComponent = dynamic(() => import("@/components/lottie-client/lottie-dynamic-load-client"), { ssr: false })
const UtilityBillPayments = dynamic(() => import("@/components/utility-bill-payments"))
const PartnerSection = dynamic(() => import("@/components/partner-section-data"))
const ScrollableCardsSection = dynamic(() => import("@/src/components/scrollable-cards-section"))
const PrepaidCardHome = dynamic(() => import("@/components/prepaid-card-home/PrepaidCardHome"))
const HomePageRewardsVouchers = dynamic(() => import("@/components/home-page-rewards-vouchers"))
const HomeReceivablesPayables = dynamic(() => import("@/components/home-receivables-payables"))
const Counter = dynamic(() => import("@/components/home-counter"), { ssr: false })
const HomePageSlider = dynamic(() => import("@/components/home-page-slider"), { ssr: false })
const BuiltforBuildersSection = dynamic(() => import("@/components/builtfor-builders-card"))
const BottomCtaSection = dynamic(() => import("@/components/bottom-cta-section"))
