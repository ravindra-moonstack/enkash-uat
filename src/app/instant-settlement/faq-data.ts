...
const faqData: TFAQProps[] = [
  {
    ...
    answer: [
      {
        heading:
          "Instant Settlement in a payment gateway refers to the process of transferring funds from the customer's account to the merchant's account after a successful transaction.",
      },
      {
        heading:
