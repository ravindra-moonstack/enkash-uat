...
const cardsData = [
  {
    title: "Link",
    description: "Link your bank accounts to view balances & initiate payouts instantly.",
    icon: scrollIconOne,
  },
  {
    title: "Routing",
...
const paymentMethodData = [
  {
    ...
    description: "Custom pricing, early feature access, and a dedicated account manager.",
    icon: cards,
  },
  {
    title: "Support That Goes Beyond the Ticket",
    description:"Human-first support via WhatsApp, email, or phone; real help, always.",
    icon: upi,
  },
  {
    title: "Direct Payouts from Your Bank",
    description:"Pay directly from your bank account - no wallet, no fund transfers.",
    icon: netBanking,
  },
