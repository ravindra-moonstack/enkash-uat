...
const BankSolutionSubHeading = {
    content: [
        { title: "If you are a startup owner, an influencer and an enterprise, or an employer, these co-branded products have been designed for you.", color: "color-black f-2" },
    ],
    headingTag: "h5",
...
const partnershipsPage = (): React.JSX.Element => {
    return (
        <div className={`color-white  `}>
            ...
            <ProductsSection sectionTitle="Types of Co-branded Cards You Can Launch" products={productsData} />
