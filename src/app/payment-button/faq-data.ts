...
export const SecondfaqData = [
  {
    ...
    answer: [
      {
        heading:
          "Perfect for fixed-price payments. Designed for merchants that sell products or services at a set price.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    answer: [
      {
        heading:
          "Add advanced options for tailored use cases. Perfect for merchants with unique payment needs. This button can be configured to match your exact requirements.",
      },
    ],
  },
]
