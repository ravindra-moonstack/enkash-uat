        ...
        <div className="max-w-auto px-4">
          ...
          <div className={`${styles.title} col-12 `}>
            ...
            <div className="d-inline text-center">
              <Heading
                title="Automate your SaaS business subscriptions for better expense control and auto-renewal."
                color="black"
                size="h5"
                weight="4"
                useH1TagInHtml={true}
      ...
      <div className={`${styles.action_row} bg-white row-padding `}>
        <div className="max-w-auto">
          <div className={`${styles.title} text-center pb-md-5 pb-5`}>
            <Heading
              title={`How To Get Started with SaaS Cards ${space}`}
              color="black"
              size="h1"
              weight="5"
            />
...
`}
      ...
      <div className={`${styles.fifth_row} relative`}>
        <div className={`${styles.title} text-center pb-5 max-w-auto`}>
          ...
          >
            <Heading
              title={`Key Features of SaaS Card ${space}`}
              color="black"
              size="h1"
              weight="5"
            />
