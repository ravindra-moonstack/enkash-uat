                ...
                <div className="d-flex flex-column text-center">
                  ...
                  <DynamicHeading
                    content={[
                      {
                        title:
                          "Your partnership enquiry has been received. Our team is reviewing the details and will reach out shortly to discuss how we can build value together.",
...
export default ConfirmationPartner
