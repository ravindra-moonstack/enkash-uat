...
const cardsData = [
  {
    ...
    description: "Instantly set up unique virtual payment addresses for each customer, branch, or department.",
    icon: scrollIconOne,
  },
  {
    title: "Collect Payment",
    description: "Receive payments via NEFT, RTGS, IMPS, or other channels directly to your virtual bank accounts.",
    icon: scrollIconTwo,
  },
  {
    title: "Stay Informed",
    description: "Real-time alerts and centralized dashboards, for smooth reconciliation and transparency.",
