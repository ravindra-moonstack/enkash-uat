import { BuiltforBuildersCardIcon } from "./img"
...
const stepsData = [
  ...
  },
  {
    stepNumber: "Steps 2",
    title: "Refer",
    description: "Refer merchants and businesses through our dashboard",
  },
  {
    stepNumber: "Steps 3",
    title: "Earn",
    description:
      "Receive commissions for every transaction that the business makes.",
  },
]
...
const BuiltforBuildersCardData = [
  ...
  },
  {
    ...
    subtitle: "WooCommerce, Magento, OpenCart",
  ...
  },
  {
    ...
    subtitle: "Hosted Checkout and Server-to-Server",
