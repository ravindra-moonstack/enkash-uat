...
import { BankSolutionHeading, bankSolutions, BuiltforBuildersCardData, headingData, slideData, stepsData } from './data'
...
const BankSolutionSubHeading = {
    content: [
        { title: "Whether you're a tech innovator, service provider, or business enabler, EnKash’s payment gateway partner program is tailored for you.", color: "color-black f-2" },
    ],
    headingTag: "h5",
    ...
    return (
        <div className={`color-white  `}>
            ...
            <BpHeroSection
                ...
                mainHeading={[
                    { title: "Payment Gateway Partner Program ", color: "color-white underline" },
                ]}
                breadcrumbs={{
                    items: [
                        { name: "Home", url: "/" },
