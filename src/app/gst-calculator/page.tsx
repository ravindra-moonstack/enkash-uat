  ...
  return (
    <div className={`color-white ${styles.home_container}`}>
      <div className="max-w-auto">
        ...
        <div className={`bg-white rounded-4  mt-5 ${styles.gst}`}>
          ...
          <div className="table-responsive mt-5">
            <DynamicHeading
              content={[
                {
                  title: "New Vs Old GST Slabs in India (FY 2025-26)",
                  color: "color-equity-blue ",
                },
              ]}
              headingTag="h3"
          ...
          <div className="pt-5">
            ...
            <CommanButton
              ...
              url="https://www.enkash.com/resources/blog/types-of-gst-rates-in-india-new-rate-list-and-updates"
            />
          </div>
        </div>
