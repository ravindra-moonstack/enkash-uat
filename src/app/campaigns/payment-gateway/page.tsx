...
export const metadata: Metadata = {
  ...generateMetaData({
    title:
      "Best Payment Gateway in India to Accept Payments Online | EnKash Campaigns",
    description:
      "Power your business checkouts with EnKash Payment Gateway. Instant integration, RBI-authorised, and advanced fraud protection.",
